...
Please allow Shizuku to run in the background.adb shell /data/app/~~BLjuiWqIGmDGpKuZJIr3uA==/moe.shizuku.privileged.api-uDUmWC4jRCbhiuOfpMskcg==/lib/arm64/libshizuku.so
